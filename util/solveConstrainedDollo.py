...
"""
import sys
sys.path.append('/opt/common/gurobi1002/linux64/lib')  # For the other function
sys.path.append('/opt/common/gurobi1002/linux64/lib/python3.9_utf32')  # For gurobipy
