...
def main(args):
    ...
    if method == 'condor':
        ...
        condor_fname = f'{simulation_dir}/condor/n{n}_m{m}_p{p}_k{k}_d{d}_r{s}_B.csv'
        condor_newick = f'{simulation_dir}/condor/n{n}_m{m}_p{p}_k{k}_d{d}_r{s}_tree.newick'
    ...
    # evaluate
    gt_fname = f'{simulation_dir}/ground_truth/n{n}_m{m}_p{p}_k{k}_d{d}_r{s}_character_matrix_without_noise.csv'
    gt_newick = f'{simulation_dir}/ground_truth/n{n}_m{m}_p{p}_k{k}_d{d}_r{s}_tree.newick'
    gt_multi = f'{simulation_dir}/ground_truth/n{n}_m{m}_p{p}_k{k}_d{d}_r{s}_multi_state_character_matrix.csv'
